...
function Logo() {
  ...
  return (
      ...
      <div className="h-full flex justify-center items-center">
        <h1 className="text-white text-4xl font-normal relative inline-block">
          <span id="before-te1" className="absolute top-0 left-0.5 w-full h-full bg-transparent" style={{ textShadow: "-2px 0 #fc0000", clipPath: "rect(24px, 550px, 90px, 0)" }} aria-hidden="true">lean<b>Funte(⚡);</b></span> {/* glitch::before */}
          lean<b>Funte(⚡);</b>
          <span id="after-te1" className="absolute top-0 -left-0.5 w-full h-full bg-transparent" style={{ textShadow: "-2px 0 spin(#49FC00, 180)", clipPath: "rect(85px, 550px, 140px, 0)" }} aria-hidden="true">lean<b>Funte(⚡);</b></span> {/* glitch::after */}
        </h1>
      </div>
    )
}
